export const Breakpoints = () => (
	<>
		{process.env.NODE_ENV !== "production" && (
			<div className="fixed bottom-0 right-0 m-2 flex items-center rounded border border-gray-400 dark:border-gray-500 dark:text-white/80 dark:bg-black bg-gray-300 p-2 text-sm">
				Current breakpoint
